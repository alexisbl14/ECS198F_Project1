...
class MainActivity : AppCompatActivity() {
    ...
    val foodTrucks = listOf(
        FoodTruck(
            0, "Authentic Street Taco", R.drawable.authenticstreettacos, "Silo Patio",
            "11am - 4pm", "A unique blend of street taco with high-quality ingredients" +
                    " to give you the highest quality Mexican food.", "https://www.authenticstreettaco.com/"
        ),
        FoodTruck(
            1, "Buckhorn Grill", R.drawable.buckhorngrill, "Silo Patio",
            "10am - 2pm", "The idea of the Buckhorn Grill was born out of " +
                    ...
                    "Really Good Food, Real Fast.", "https://buckhorngrill.com/"
        ),
        FoodTruck(
            2, "Shah's Halal", R.drawable.shahshalal, "Silo Patio",
            "12am - 4pm", "Owned and operated by Tory Mashriqi, Shah’s " +
                    ...
                    "they are cooked over a large flat griddle.", "https://shahshalalfood.myfreesites.net/"
        ),
        FoodTruck(
            3, "Star Ginger", R.drawable.starginger, "Silo Patio",
            "1pm - 4pm", "Fresh Asian flavors for campus, corporate, " +
        ...
        FoodTruck(
            ...
            "2pm - 6pm", "We are a Latin fusion food truck buffet, inspired " +
                    ...
                    "us.", "https://www.labanginbowls.com/"
        ),
        FoodTruck(
            5, "Hefty Gyros", R.drawable.heftygyros, "Storer Hall",
            "1pm - 4pm", "Hefty Gyros is a family owned and operated food " +
                    ...
                    "authentic and delicious Mediterranean food.", "https://heftygyros.com/"
        )
    )
